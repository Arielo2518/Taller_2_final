...
```{r}
remove(datos_comunas1_2021, datos_comunas2_2021, metropolitana_2021_1, metropolitana_2021_2, datos_comunas1_2021, datos_comunas2_2021)
```
...
casen_2021_rm_actualizada <- casen_2021_rm %>%
  ...
  filter(complete.cases(.))                       # Filtrar filas sin NA                                    # Eliminar filas con NA
```
